      ...
      <AnimatePresence>
        {isVisible && (
          <motion.button
            ...
            onClick={scrollToTop}
            className="fixed bottom-8 right-8 z-[100] p-4 rounded-2xl bg-[#030014] border border-white/30 text-white shadow-2xl hover:border-purple-500/50 hover:shadow-purple-500/20 transition-all backdrop-blur-xl group"
          >
